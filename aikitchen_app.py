...
def create_pdf(recipe_text: str) -> io.BytesIO:
    pdf = FPDF()
    pdf.add_page()
    pdf.set_font("Arial", size=12)

    # Title
    pdf.cell(200, 10, txt="Recipe Generated by AI Kitchen", ln=True, align="C")
    pdf.ln(10)
...
def main():
    ...
    if query := st.chat_input("Ask me anything..."):
        ...
        # Generate PDF after assistant response
        if assistant_response:
            pdf_file = create_pdf(assistant_response)
            st.download_button(
